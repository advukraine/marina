...
const translations = {
  pl: {
    ...
    hero_sub: 'Manicure, pedicure, brwi i rzęsy, makijaż permanentny oraz masaż endosferyczny w Siechnicach.',
    btn_call: 'Zadzwoń',
    btn_call_book: 'Zadzwoń i umów wizytę',

    services_title: 'Usługi',
    services_lead: 'Pięć kierunków pracy studia — kliknij, aby zobaczyć ceny.',
    ...
    pm_kor3: 'korekta do 3 m',
    pm_kor12: 'korekta do 1 roku',
  ...
  ua: {
    ...
    hero_sub: 'Манікюр, педикюр, брови та вії, перманентний макіяж і ендосферний масаж у Сехницях.',
    btn_call: 'Зателефонувати',
    btn_call_book: 'Зателефонувати і записатися',

    services_title: 'Послуги',
    services_lead: 'П’ять напрямків роботи студії — натисніть, щоб побачити ціни.',
    ...
    pm_kor3: 'корекція до 3 місяців',
    pm_kor12: 'корекція до 1 року',
